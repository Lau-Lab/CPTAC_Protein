...
# Reorder factors
df_all$method <- factor(df_all$method, levels=c('boosting'), labels = c('Gradient Boosting'))
...
ggsave(plot=g, filename="PLOS_Fig2B.pdf", width=12, height=9, useDingbats=F)
ggsave(plot=g, filename="PLOS_Fig2B.png", width=12, height=9)
