...
# Reorder factors
df_all$method <- factor(df_all$method, levels=c('linreg', 'elastic', 'forest'))
...
ggsave(plot=g, filename="PLOS_FigS2.pdf", width=12, height=9, useDingbats=F)
ggsave(plot=g, filename="PLOS_FigS2.png", width=12, height=9)
